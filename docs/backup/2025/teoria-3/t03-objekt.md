...
Identita (anglicky identity) reprezentuje jedinečnosť danej veci, jej výnimočnosť. Identita veci sa v čase nemení, ale hodnota (anglicky value) o danej veci sa meniť môže. Ak si môj spolužiak zmení meno z Fero na Hugo, bude to stále ten istý človek. Ak si prestiekam svoje auto na inú farbu, stále to bude to moje auto.
