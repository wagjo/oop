...
!!! info "Pokročilé techniky: Generické metódy"
  ...
  <aside markdown>
Parametrizované typy sa dajú ohraničiť, ak chceme obmedziť možné konktétne typy iba na určitú podmnožinu typov. Vymazanie typov by potom prebiehalo trochu inak. Táto pokročilá technika však je nad rámec dnešnej lekcie.
</aside>
</div>
