...
Medzi ďalšie užitočné nastavenia patria nastavenie minimálnej a maximálnej veľkosti okna (napr. `setMaxWidth()`) a nastavenie, či chceme aby užívateľ mohol meniť veľkosť okna (`setResizable()`)
